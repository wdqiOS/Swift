...
//        print("请输入数字")
    ...
    func setupUI() -> () {
        // 1.两个textfield
        let tf1 = UITextField(frame: CGRect(x: 20, y: 20, width: 100, height: 30), placeholoader: "0")
//        let tf1 = UITextField(frame: CGRect(x: 20, y: 20, width: 100, height: 30))
//        tf1.borderStyle = .roundedRect
//        tf1.text = "0"
        view.addSubview(tf1)
        
        let tf2 = UITextField(frame: CGRect(x: 140, y: 20, width: 100, height: 30), placeholoader: "0")
...
//        l1.textAlignment = .center
        let l1 = UILabel(frame: CGRect(x: 120, y: 20, width: 20, height: 20), text: "+", textAlignment: .center)
...
//        l2.textAlignment = NSTextAlignment.center
        let l2 = UILabel(frame: CGRect(x: 240, y: 20, width: 20, height: 20), text: "=", textAlignment: .center)
        view.addSubview(l2)
        
//        let l3 = UILabel(frame: CGRect(x: 240, y: 20, width: 60, height: 20))
//        l3.text = "0"
//        l3.textAlignment = .right
        let l3 = UILabel(frame: CGRect(x: 240, y: 20, width: 60, height: 20), text: "0", textAlignment: .right)
        view.addSubview(l3)
